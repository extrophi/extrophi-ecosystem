...
### Step 3: create a *path operation*[¶](#step-3-create-a-path-operation "Permanent link")
...
#### Define a *path operation decorator*[¶](#define-a-path-operation-decorator "Permanent link")
